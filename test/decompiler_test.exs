...
#  end
  ...
  test "decompile module calling enum map" do
    assert {:ok, ModuleCallsEnumMap,
           %Decompile{
             atoms: {ModuleCallsEnumMap, :__info__, :attributes, :compile, :deprecated,
              :functions, :macros, :md5, :module, :erlang, :get_module_info, :f, Enum,
              :map, :module_info, :"-f/0-fun-0-", :+},
             code: [
               label: 1,
               line: [],
               ...
               label: 14,
               line: [2],
               gc_bif2: [{:f, 0}, 1, {:erlang, :+, 2}, {:x, 0}, 1, {:x, 0}]
             ],
             exports: {{:module_info, 1, {:label, 12}}, {:module_info, 0, {:label, 10}},
              {:f, 0, {:label, 8}}, {:__info__, 1, {:label, 2}}},
             imports: {{:erlang, :get_module_info, 2}, {Enum, :map, 2},
              {:erlang, :get_module_info, 1}, {:erlang, :+, 2}},
             instruction_set: 0,
             literals: {[f: 0], [1, 2, 3]},
